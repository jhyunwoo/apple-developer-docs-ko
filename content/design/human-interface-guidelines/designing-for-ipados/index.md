---
route: /design/human-interface-guidelines/designing-for-ipados
source_url: https://developer.apple.com/design/human-interface-guidelines/designing-for-ipados
source_locale: ko-KR
section: hig
content_type: article
title: iPadOS용으로 디자인하기
original_title: Designing for iPadOS
source_hash: b39f20bf89f62ec9ffb03efbe3f431a94ff748125c7f5dfd48e76eea5f30f83e
canonical_source: official-ko
last_crawled_at: '2026-03-13T02:35:42+00:00'
last_translated_at: '2026-03-13T02:35:42+00:00'
---
...
![그리드 위에 스타일화된 iPad 프레임 모양이 표시되어 있음. 이미지에 직사각형 및 원형 그리드 선이 겹쳐져 있고, 여섯 가지 색상으로 된 기존 Apple 로고의 초록색을 은은하게 반영하는 초록색 색조가 적용됨.](https://developer.apple.com)
...
**입력.** 사람들은 Multi-Touch [gestures](https://developer.apple.com/kr/design/human-interface-guidelines/gestures) 및 [virtual keyboards](https://developer.apple.com/kr/design/human-interface-guidelines/virtual-keyboards), 연결된 [keyboard](https://developer.apple.com/kr/design/human-interface-guidelines/keyboards) 또는 [pointing device](https://developer.apple.com/kr/design/human-interface-guidelines/pointing-devices), [Apple Pencil](https://developer.apple.com/kr/design/human-interface-guidelines/apple-pencil-and-scribble) 또는 [voice](https://developer.apple.com/kr/design/human-interface-guidelines/siri)을 사용하여 iPad와 상호작용할 수 있으며, 주로 여러 입력 모드를 조합하여 사용합니다.
