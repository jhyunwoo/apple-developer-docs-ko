---
route: /design/human-interface-guidelines/going-full-screen
source_url: https://developer.apple.com/design/human-interface-guidelines/going-full-screen
source_locale: ko-KR
section: hig
content_type: article
title: 전체 화면 사용하기
original_title: Going full screen
source_hash: 61f561bebfc577f8c073fcfb70e723ed2d4701d0eddaf375752c5132c44e5e5d
canonical_source: official-ko
last_crawled_at: '2026-03-13T14:56:44+00:00'
...
![왼쪽 상단에서 오른쪽 하단으로 펼쳐지는 수직선 위에 배열된 바깥으로 향하는 두 개의 화살표 모양 스케치가 있고, 확장을 나타냄. 이미지에 직사각형 및 원형 그리드 선이 겹쳐져 있고, 여섯 가지 색상으로 된 기존 Apple 로고의 주황색을 은은하게 반영하는 주황색 색조가 적용됨.](https://developer.apple.com)
...
**전체 화면 모드로 전환할 시기를 반드시 사람들이 선택하도록 하십시오.** 사람들이 윈도우의 전체 화면 시작 버튼, 보기 메뉴 항목 또는 Control-Command-F 키보드 단축키를 사용할 수 있도록 허용하십시오. 윈도우 모드의 사용자 설정 메뉴는 제공하지 마십시오. 게임에서는 전체 화면 모드를 켜고 끄는 사용자 설정 [toggle](https://developer.apple.com/kr/design/human-interface-guidelines/toggles)을 제공할 수도 있습니다.
