---
route: /design/human-interface-guidelines/accessibility
source_url: https://developer.apple.com/design/human-interface-guidelines/accessibility
source_locale: ko-KR
section: hig
content_type: article
title: 손쉬운 사용
original_title: Accessibility
source_hash: fbfa6c87af376ce826c9a7c4162cf29121d7a14967edca7cee27a96df62b559e
canonical_source: official-ko
last_crawled_at: '2026-03-13T14:51:06+00:00'
...
![손쉬운 사용 아이콘의 스케치. 이미지에 직사각형 및 원형 그리드 선이 겹쳐져 있고, 여섯 가지 색상으로 된 기존 Apple 로고의 노란색을 은은하게 반영하는 노란색 색조가 적용됨.](https://developer.apple.com)
...
![소리, 파형 및 청각 장애인용 자막을 나타내는 기호를 포함하여 듣기 지원 주제와 관련된 다섯 가지 기호가 포함된 일러스트.](https://developer.apple.com)
...
![기기에서 음악이 재생되는 동안 iPhone 기기가 진동하는 일러스트.](https://developer.apple.com)
...
![키보드, 움직임 및 터치를 나타내는 기호를 포함하여 운동성 지원 주제와 관련된 다섯 가지 기호가 포함된 일러스트.](https://developer.apple.com)
...
![파형 및 말하기를 나타내는 기호를 포함하여 말하기 지원 주제와 관련된 다섯 가지 기호가 포함된 일러스트.](https://developer.apple.com)
...
![음악, 보안 및 정보 계층 구조를 나타내는 기호를 포함하여 인식 지원 주제와 관련된 다섯 가지 기호가 포함된 일러스트.](https://developer.apple.com)
...
추가 지침을 보려면 [접근성 높은 공간 경험 생성하기](https://developer.apple.com/videos/play/wwdc2023/10034) 및 [시각과 움직임을 고려한 디자인](https://developer.apple.com/videos/play/wwdc2023/10078)의 내용을 참조하십시오.
