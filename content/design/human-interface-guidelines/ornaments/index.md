---
route: /design/human-interface-guidelines/ornaments
source_url: https://developer.apple.com/design/human-interface-guidelines/ornaments
source_locale: ko-KR
section: hig
content_type: article
title: 오너먼트
original_title: Ornaments
source_hash: d9b974dc3e1c2d24feeb22131050a8bf904cd0d192d72fb7847107505eea3ac4
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:05:07+00:00'
...
![윈도우 하단의 오너먼트가 스타일화된 모양으로 그리드 위에 표시되어 있으며 디자인 도구의 캔버스를 나타냄. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
**오너먼트에 테두리가 없는 버튼을 사용하는 것을 고려하십시오.** 기본적으로 오너먼트의 배경은 [머티리얼](https://developer.apple.com/kr/design/human-interface-guidelines/materials#visionOS)이므로 배경에 직접 버튼을 배치하는 경우 테두리를 표시할 필요가 없습니다. 사람들이 오너먼트의 테두리가 없는 버튼을 바라볼 때 시스템은 자동으로 해당 버튼에 호버 효과를 적용합니다(지침을 보려면 [눈](https://developer.apple.com/kr/design/human-interface-guidelines/eyes)의 내용 참조).
