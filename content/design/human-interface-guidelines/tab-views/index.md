---
route: /design/human-interface-guidelines/tab-views
source_url: https://developer.apple.com/design/human-interface-guidelines/tab-views
source_locale: ko-KR
section: hig
content_type: article
title: 탭 보기
original_title: Tab views
source_hash: c65213ab8fb9744b0db9dbd733e50eaf4834cd0817a1f81350ec5aa560cbf683
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:03:10+00:00'
...
![레이블이 지정된 두 개의 탭이 있고 그 중 첫 번째 탭이 선택된 보기의 스타일화된 모양이 표시되어 있음. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
유사한 기능의 경우 [segmented control](https://developer.apple.com/kr/design/human-interface-guidelines/segmented-controls)를 대신 사용하는 것을 고려하십시오.

### watchOS

watchOS는 [page controls](https://developer.apple.com/design/human-interface-guidelines/components/presentation/page-controls)를 사용하여 탭 보기를 표시합니다. 개발자 지침을 보려면 [TabView](https://developer.apple.com/documentation/SwiftUI/TabView) 및 [verticalPage](https://developer.apple.com/documentation/SwiftUI/TabViewStyle/verticalPage)의 내용을 참조하십시오.

![Apple Watch의 Digital Crown 옆에 페이지 제어기를 보여주는 일러스트. 현재 점이 확대되며, 사람들이 현재 콘텐츠를 스크롤할 뿐만 아니라 페이지 간에 스크롤할 수 있음을 나타냄.](https://developer.apple.com)
