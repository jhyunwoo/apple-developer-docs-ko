---
route: /design/human-interface-guidelines/column-views
source_url: https://developer.apple.com/design/human-interface-guidelines/column-views
source_locale: ko-KR
section: hig
content_type: article
title: 계층 보기
original_title: Column views
source_hash: a8f02f12f35c92a2aa6394397c531caa17e8c4787191922129f3e530731241f7
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:02:09+00:00'
...
![폴더, 이미지 및 파일 정보 목록이 포함된 세 개의 스타일화된 계층 모양이 표시되어 있음. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
:::note 참고
iPadOS 또는 visionOS 앱의 계층적 콘텐츠가 표시되는 방식을 관리해야 하는 경우, [Split View](https://developer.apple.com/kr/design/human-interface-guidelines/split-views)를 사용하는 것을 고려하십시오.
:::
