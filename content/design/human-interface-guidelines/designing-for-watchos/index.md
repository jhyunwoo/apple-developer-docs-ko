---
route: /design/human-interface-guidelines/designing-for-watchos
source_url: https://developer.apple.com/design/human-interface-guidelines/designing-for-watchos
source_locale: ko-KR
section: hig
content_type: article
title: watchOS용으로 디자인하기
original_title: Designing for watchOS
source_hash: ddf627a6b5b8f36afa56d2e325318d5d1c95acba94bc06398bf06f2efc233e8f
canonical_source: official-ko
last_crawled_at: '2026-03-13T14:50:59+00:00'
...
![그리드 위에 스타일화된 Apple Watch 프레임 모양이 표시되어 있음. 이미지에 직사각형 및 원형 그리드 선이 겹쳐져 있고, 여섯 가지 색상으로 된 기존 Apple 로고의 초록색을 은은하게 반영하는 초록색 색조가 적용됨.](https://developer.apple.com)
...
**입력.** 사람들은 [Digital Crown](https://developer.apple.com/kr/design/human-interface-guidelines/digital-crown)을 돌려 수직으로 탐색하거나 데이터를 검사할 수 있으며, 이는 시계 페이스, 홈 화면 및 앱 내에서 일관적인 제어를 제공합니다. 이동하고 있는 중에도 탭, 쓸어넘기기, 드래그와 같은 기본 [gestures](https://developer.apple.com/kr/design/human-interface-guidelines/gestures)를 사용하여 입력을 제공할 수 있습니다. [동작 버튼](https://developer.apple.com/kr/design/human-interface-guidelines/action-button)을 누르면 화면을 보지 않고도 필수 동작을 실행할 수 있으며, [shortcuts](https://developer.apple.com/kr/design/human-interface-guidelines/siri#Shortcuts-and-suggestions)를 사용하여 반복적인 작업을 쉽고 빠르게 수행할 수 있습니다. 또한 사람들은 GPS, 혈중 산소 및 심장 기능 센서, 고도계, 가속도계, 자이로스코프와 같은 기기의 기능이 제공하는 데이터의 이점을 활용할 수 있습니다.
...
- [complications](https://developer.apple.com/kr/design/human-interface-guidelines/complications)을 사용하여 관련성이 있고 동적으로 변화될 가능성이 있는 데이터와 그래픽을 시계 페이스에 제공하여 사람들이 손목을 들어 올릴 때마다 정보를 확인하고 탭하여 바로 앱으로 이동할 수 있도록 하십시오.
- [notifications](https://developer.apple.com/kr/design/human-interface-guidelines/notifications)을 사용하여 가치 있는 정보를 적시에 제공하고, 사람들이 앱을 열지 않고도 중요한 동작을 수행할 수 있도록 하십시오.
- [color](https://developer.apple.com/kr/design/human-interface-guidelines/color)과 같은 배경 콘텐츠를 사용하여 유용한 보조 정보를 포함하고, [materials](https://developer.apple.com/kr/design/human-interface-guidelines/materials)을 사용하여 계층과 위치감을 나타내십시오.
- Siri를 지원하여 사람들이 Siri 시계 페이스에서 단축어에 접근할 수 있도록 하십시오.
