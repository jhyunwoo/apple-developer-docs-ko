---
route: /design/human-interface-guidelines/controls
source_url: https://developer.apple.com/design/human-interface-guidelines/controls
source_locale: ko-KR
section: hig
content_type: article
title: 제어기
original_title: Controls
source_hash: 66bc18342a841e07d0172a512e7a7268c9b31845494498b6aa7424ce33bee6d8
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:12:54+00:00'
last_translated_at: '2026-03-14T00:12:46+09:00'
---

# 제어기

iOS 및 iPadOS에서 제어 센터, 잠금 화면 또는 동작 버튼의 제어기를 통해 앱의 기능에 빠르게 접근할 수 있습니다.

![에어플레인 모드 토글, Wi-Fi 토글, AirPlay 버튼과 같은 제어 센터 제어기의 부분적 스크린샷. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)

제어기는 시스템의 다른 영역에서 앱 기능에 빠르게 접근하게 해주는 버튼 또는 토글을 의미합니다. 제어기 버튼은 동작을 수행하거나, 앱의 특정 영역으로 링크하거나, [제어기](https://developer.apple.com/kr/design/human-interface-guidelines/controls#Camera-experiences-on-a-locked-device)합니다. 제어기 토글은 켬, 끔과 같은 두 가지 상태 간에 전환합니다.
...
![제어기 토글의 기호 이미지, 제목, 값에 대한 배치가 표시된 다이어그램.](https://developer.apple.com)
...
![사람들이 선택하는 값으로 옵션을 설정할 수 있는 기능이 표시된 제어기의 화면.](https://developer.apple.com)
...
*iOS 또는 iPadOS에 대한 추가 고려 사항은 없습니다. macOS, watchOS, tvOS 또는 visionOS에서는 지원되지 않습니다.*
