---
route: /design/human-interface-guidelines/token-fields
source_url: https://developer.apple.com/design/human-interface-guidelines/token-fields
source_locale: ko-KR
section: hig
content_type: article
title: 토큰 필드
original_title: Token fields
source_hash: 9385c7fb6d2d1d6ef26ace6c5d559e21155bfc8200ed4dd3a59343c32586d14e
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:07:00+00:00'
...
![토큰으로 포맷된 한 사람의 이름이 포함된 텍스트 필드의 스타일화된 모양이 표시되어 있음. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
![토큰이 일부 받는 사람을 나타내는 Mail 작성 윈도우의 부분적인 스크린샷.](https://developer.apple.com)
...
![하나의 받는 사람 토큰이 명령 메뉴를 표시하는 Mail 작성 윈도우의 부분적인 스크린샷.](https://developer.apple.com)
...
**빠른 메뉴로 값을 추가하십시오.** 사람들은 토큰에 대한 추가 옵션이나 정보가 있는 [context menu](https://developer.apple.com/kr/design/human-interface-guidelines/context-menus)를 이용하는 경우가 많습니다.
