---
route: /design/human-interface-guidelines/home-screen-quick-actions
source_url: https://developer.apple.com/design/human-interface-guidelines/home-screen-quick-actions
source_locale: ko-KR
section: hig
content_type: article
title: 홈 화면 빠른 동작
original_title: Home Screen quick actions
source_hash: 7c8522d6fb888438ae1252db63558e5d80df0892579ffd0689cfbae96d40eacd
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:05:03+00:00'
...
![앱 아이콘에서 위로 확장되는 일련의 메뉴 항목의 스타일화된 모양이 표시되어 있음. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
**각각의 빠른 동작에 익숙한 인터페이스 아이콘을 제공하십시오.** 동작을 나타내기 위해 [SF Symbols](https://developer.apple.com/kr/design/human-interface-guidelines/sf-symbols)를 사용하는 것이 좋습니다. 자주 쓰는 동작을 나타내는 아이콘 목록을 보려면 [아이콘](https://developer.apple.com/kr/design/human-interface-guidelines/icons#Standard-icons)의 내용을 참조하십시오. 추가 지침을 보려면 [메뉴](https://developer.apple.com/kr/design/human-interface-guidelines/menus)의 내용을 참조하십시오.
...
**기호 또는 인터페이스 아이콘 대신 이모티콘을 사용하지 마십시오.** 이모티콘은 풀컬러인 반면, 빠른 동작 기호는 단색이며 대비를 유지하기 위해 다크 모드에서 모양이 변경됩니다.
