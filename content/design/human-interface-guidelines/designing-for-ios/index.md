---
route: /design/human-interface-guidelines/designing-for-ios
source_url: https://developer.apple.com/design/human-interface-guidelines/designing-for-ios
source_locale: ko-KR
section: hig
content_type: article
title: iOS용으로 디자인하기
original_title: Designing for iOS
source_hash: b0b0d119317de2277da382c1c1e0156069a761c920cebea4567a742b962eaa9e
canonical_source: official-ko
last_crawled_at: '2026-03-13T02:35:40+00:00'
last_translated_at: '2026-03-13T02:35:40+00:00'
---
...
![그리드 위에 스타일화된 iPhone 프레임 모양이 표시되어 있음. 이미지에 직사각형 및 원형 그리드 선이 겹쳐져 있고, 여섯 가지 색상으로 된 기존 Apple 로고의 초록색을 은은하게 반영하는 초록색 색조가 적용됨.](https://developer.apple.com)
...
**입력.** 사람들은 Multi-Touch [gestures](https://developer.apple.com/kr/design/human-interface-guidelines/gestures), [virtual keyboards](https://developer.apple.com/kr/design/human-interface-guidelines/virtual-keyboards) 및 [voice](https://developer.apple.com/kr/design/human-interface-guidelines/siri) 명령을 사용하여 이동 중에 동작을 수행하고 의미 있는 작업을 완료할 수 있습니다. 또한 사람들은 대체적으로 앱이 자신의 [personal data](https://developer.apple.com/kr/design/human-interface-guidelines/privacy)를 사용하고 기기의 [gyroscope and accelerometer](https://developer.apple.com/kr/design/human-interface-guidelines/gyro-and-accelerometer) 입력을 사용하기를 원하며, [spatial interactions](https://developer.apple.com/design/human-interface-guidelines/spatial-interactions)에 참여하는 것을 원하기도 합니다.
...
- [Spotlight](https://developer.apple.com/kr/design/human-interface-guidelines/searching)
- [Shortcuts](https://developer.apple.com/kr/design/human-interface-guidelines/siri#Shortcuts-and-suggestions)
