---
route: /design/human-interface-guidelines/designing-for-tvos
source_url: https://developer.apple.com/design/human-interface-guidelines/designing-for-tvos
source_locale: ko-KR
section: hig
content_type: article
title: tvOS용으로 디자인하기
original_title: Designing for tvOS
source_hash: d50ca08f0488290f927bec5eb08a3b0db54a67226b6eb346eee47a7e4913c932
...
**입력.** 사람들은 [리모컨](https://developer.apple.com/design/human-interface-guidelines/remotes), [게임 컨트롤러](https://developer.apple.com/design/human-interface-guidelines/game-controls), [음성](https://developer.apple.com/design/human-interface-guidelines/siri) 및 다른 기기에서 실행되는 앱을 사용하여 Apple TV와 상호작용합니다.
...
- [TV 앱과의 통합](https://developer.apple.com/design/human-interface-guidelines/playing-video#Integrating-with-the-TV-app)
- [SharePlay](https://developer.apple.com/design/human-interface-guidelines/shareplay)
- [상단](https://developer.apple.com/design/human-interface-guidelines/top-shelf)
- [TV 제공업체 계정](https://developer.apple.com/design/human-interface-guidelines/managing-accounts#TV-provider-accounts)
...
[Apple 디자인 리소스](https://developer.apple.com/design/resources/#tvos-apps)
...
- [Create complications for tvOS and watchOS](https://developer.apple.com/videos/play/wwdc2020/10042)
