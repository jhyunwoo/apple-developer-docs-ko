---
route: /design/human-interface-guidelines/text-fields
source_url: https://developer.apple.com/design/human-interface-guidelines/text-fields
source_locale: ko-KR
section: hig
content_type: article
title: 텍스트 필드
original_title: Text fields
source_hash: e2c4fbf1cde87b82493264eb65e1df24d2a2584caf9ab3b7bed6d99e32464ba5
canonical_source: official-ko
last_crawled_at: '2026-03-13T15:10:51+00:00'
...
![값을 포함하고 있는 텍스트 필드의 스타일화된 모양. 여섯 가지 색상으로 된 기존 Apple 로고의 빨간색을 은은하게 반영하는 빨간색 색조가 이미지에 적용됨.](https://developer.apple.com)
...
![쌓여 있는 두 개의 텍스트 필드의 부분적 스크린샷. 상단 필드는 소수점 네 자리까지 있는 숫자를 포함하고 있음. 하단 필드는 통화 값을 포함하고 있음.](https://developer.apple.com)
...
**클리핑되거나 잘린 텍스트의 전체 내용을 표시하도록 확장 툴팁을 사용하는 것을 고려하십시오.** 확장 툴팁은 일반적인 [tooltip](https://developer.apple.com/kr/design/human-interface-guidelines/offering-help#macOS-visionOS)처럼 동작하며 포인터가 필드 위에 있을 때 나타납니다.
